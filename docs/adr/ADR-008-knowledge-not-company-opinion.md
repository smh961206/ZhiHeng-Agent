# Knowledge Does Not Store Current Company Opinions

Status: ACCEPTED

## Decision

Knowledge contains research method, ontology and playbooks. Current company thesis/valuation belongs to Research State/Claims.
...
Implementation Status: CURRENT. Active Knowledge is method/rules, pinned per job; canonical company-state entities remain future.
