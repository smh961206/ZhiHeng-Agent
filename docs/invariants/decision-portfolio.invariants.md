# Decision / Portfolio Invariants

- INV-DEC-001 [TARGET V5.9]: research conclusion and investor action are separate objects.
- INV-DEC-002 [TARGET V5.9]: a decision must reference the mandate/context that produced it.
