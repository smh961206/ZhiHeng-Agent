...
Complete zero-behavior-change bootstrap and authorize V4.8 as next release.
...
Before H0.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Run complete tests.
- Produce H0 completion report.
- Set CURRENT=V4.8 only after all H0 acceptance cases pass.
...
- **H0.3-AC01:** Runtime behavior change=0.
- **H0.3-AC02:** CURRENT=V4.8 after acceptance.
- **H0.3-AC03:** Codex stops after handoff.
