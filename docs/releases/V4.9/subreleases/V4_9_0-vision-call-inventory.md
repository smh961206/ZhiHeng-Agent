...
Inventory image/scanned-PDF model calls, current limits and evidence semantics.
...
Before V4.9.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Vision call map
- Current request/image/page/timeout limits
- Current model-name capability branches
...
- Vision call inventory regression tests
...
- **V4.9.0-AC01:** Inventory image/scanned-PDF model calls, current limits and evidence semantics. without weakening Vision unverified-evidence rules.
