# V4.9.1 — Vision canonical request

Release: `V4.9`
Implementation Status: CURRENT implementation and offline validation. See [report](../V4_9_1-completion-report.md). Real candidate quality and production promotion remain unaccepted.

## 1. Why

Normalize image/messages/purpose/requiredCapabilities through Gateway.
...
Before V4.9.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Canonical vision request
- imageInput capability filter
...
- Vision canonical request regression tests
...
- **V4.9.1-AC01:** Normalize image/messages/purpose/requiredCapabilities through Gateway. without weakening Vision unverified-evidence rules.
