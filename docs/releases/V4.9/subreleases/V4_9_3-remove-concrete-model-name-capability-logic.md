...
Replace business model-name checks with catalog capabilities/adapter behavior.
...
Before V4.9.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Capability-based image/thinking decisions
- Compatibility tests
...
- Remove concrete model-name capability logic regression tests
...
- **V4.9.3-AC01:** Replace business model-name checks with catalog capabilities/adapter behavior. without weakening Vision unverified-evidence rules.
