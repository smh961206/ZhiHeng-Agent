# V4.9.5 — Vision graders

Release: `V4.9`
Implementation Status: CURRENT implementation and offline validation. See [report](../V4_9_5-completion-report.md). Real candidate quality and production promotion remain unaccepted.

## 1. Why

Implement deterministic/targeted graders for table-reading quality.
...
Before V4.9.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Numeric/unit/date/header/relationship scoring

## 7. Out of Scope

- LLM judge as sole grader
...
- Vision graders regression tests
...
- **V4.9.5-AC01:** Implement deterministic/targeted graders for table-reading quality. without weakening Vision unverified-evidence rules.
