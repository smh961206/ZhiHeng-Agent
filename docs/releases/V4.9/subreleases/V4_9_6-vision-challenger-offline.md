# V4.9.6 — Vision challenger offline

Release: `V4.9`
Implementation Status: CURRENT implementation and offline validation. See [report](../V4_9_6-completion-report.md). Real candidate quality and production promotion remain unaccepted.

## 1. Why

Add second image-capable profile and run offline benchmark.
...
Before V4.9.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Vision challenger offline regression tests
...
- **V4.9.6-AC01:** Add second image-capable profile and run offline benchmark. without weakening Vision unverified-evidence rules.
