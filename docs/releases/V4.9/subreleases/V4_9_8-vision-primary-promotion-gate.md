...
Promote challenger only if quality gate passes; retain old fallback.
...
Before V4.9.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Vision primary promotion gate regression tests
...
- **V4.9.8-AC01:** Promote challenger only if quality gate passes; retain old fallback. without weakening Vision unverified-evidence rules.
