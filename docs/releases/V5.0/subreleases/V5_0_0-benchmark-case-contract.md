# V5.0.0 — Benchmark case contract
...
Define canonical benchmark case metadata and quality-criticality.
...
Before V5.0.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Benchmark case contract unit/integration tests
...
- **V5.0.0-AC01:** Define canonical benchmark case metadata and quality-criticality. with versioned, reproducible evidence.
