...
Load frozen documents/market/evidence fixtures deterministically.
...
Before V5.0.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Fixture loader unit/integration tests
...
- **V5.0.1-AC01:** Load frozen documents/market/evidence fixtures deterministically. with versioned, reproducible evidence.
