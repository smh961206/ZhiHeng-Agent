...
Add job-pinned experiment assignment disabled by default.
...
Before V5.0.11, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- experimentGroup
- Assignment hash/percent

## 7. Out of Scope

- Per-turn randomization
...
- A/B assignment unit/integration tests
...
- **V5.0.11-AC01:** Add job-pinned experiment assignment disabled by default. with versioned, reproducible evidence.
