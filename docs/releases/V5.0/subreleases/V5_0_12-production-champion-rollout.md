# V5.0.12 — Production champion rollout
...
Enable champion policy progressively with benchmark/telemetry rollback.
...
Before V5.0.12, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Production champion rollout unit/integration tests
...
- **V5.0.12-AC01:** Enable champion policy progressively with benchmark/telemetry rollback. with versioned, reproducible evidence.
