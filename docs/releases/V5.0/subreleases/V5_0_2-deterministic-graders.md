...
Grade facts/citations/tool calls/validation with code where possible.
...
Before V5.0.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Deterministic graders unit/integration tests
...
- **V5.0.2-AC01:** Grade facts/citations/tool calls/validation with code where possible. with versioned, reproducible evidence.
