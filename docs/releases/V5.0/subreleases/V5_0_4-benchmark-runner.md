...
Run candidate/baseline with repeatable config and aggregate results.
...
Before V5.0.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Benchmark runner unit/integration tests
...
- **V5.0.4-AC01:** Run candidate/baseline with repeatable config and aggregate results. with versioned, reproducible evidence.
