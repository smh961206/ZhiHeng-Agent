# V5.0.6 — Challenger profile integration
...
Add second Main candidate to Catalog/policy eligibility without production routing.
...
Before V5.0.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Challenger profile integration unit/integration tests
...
- **V5.0.6-AC01:** Add second Main candidate to Catalog/policy eligibility without production routing. with versioned, reproducible evidence.
