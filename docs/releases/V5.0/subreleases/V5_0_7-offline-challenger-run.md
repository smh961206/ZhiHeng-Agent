...
Execute challenger across benchmark and record failures/cost/latency.
...
Before V5.0.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Offline challenger run unit/integration tests
...
- **V5.0.7-AC01:** Execute challenger across benchmark and record failures/cost/latency. with versioned, reproducible evidence.
