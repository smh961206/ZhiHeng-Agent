...
Require minimum sample/repeatability/tolerance before champion claim.
...
Before V5.0.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Confidence/tolerance rules
- Per-task comparison

## 7. Out of Scope

- Overclaiming small samples
...
- Statistical comparison unit/integration tests
...
- **V5.0.8-AC01:** Require minimum sample/repeatability/tolerance before champion claim. with versioned, reproducible evidence.
