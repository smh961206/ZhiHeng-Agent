...
Define benchmark/runtime task classes used for champion routing.
...
Before V5.0.9, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- quick_screen/financial_analysis/long_document/agent_tooling/review/vision_table

## 7. Out of Scope

- Per-turn random class
...
- Task classification for champion unit/integration tests
...
- **V5.0.9-AC01:** Define benchmark/runtime task classes used for champion routing. with versioned, reproducible evidence.
