...
Define effective-dated per-MToken pricing fields and currency.
...
Before V5.1.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.1.0-AC01:** Define effective-dated per-MToken pricing fields and currency. while quality remains the higher-priority gate.
