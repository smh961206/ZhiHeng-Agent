# V5.1.1 — Pricing registry/history
...
Load current and historical configured prices without guessing unknowns.
...
Before V5.1.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
Additive versioned Catalog pricing and a read-only historical configuration registry; legacy prices remain readable. See [release schema](../schema.md) and [migration](../migration.md).
...
- Pricing registry/history tests
...
- **V5.1.1-AC01:** Load current and historical configured prices without guessing unknowns. while quality remains the higher-priority gate.
