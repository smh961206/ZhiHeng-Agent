# V5.1.10 — Research budget schema
...
Define maxModelCost/toolRounds/webRequests/visionPages/duration.
...
Before V5.1.10, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
Additive version-1 budget limits and private durable budgetState in existing job payloads; absent historical budgets stay absent. See [release schema](../schema.md) and [migration](../migration.md).
...
- **V5.1.10-AC01:** Define maxModelCost/toolRounds/webRequests/visionPages/duration. while quality remains the higher-priority gate.
