# V5.1.13 — Peak/off-peak pricing support
...
Represent time-tiered pricing for same-time candidate comparison only.
...
Before V5.1.13, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Pricing tiers/timezone

## 7. Out of Scope

- Delaying synchronous user work
...
Pricing v2 adds daily timezone tiers; retained call-time cost snapshots are additive and immutable. See [release schema](../schema.md) and [migration](../migration.md).
...
- Peak/off-peak pricing support tests
...
- **V5.1.13-AC01:** Represent time-tiered pricing for same-time candidate comparison only. while quality remains the higher-priority gate.
