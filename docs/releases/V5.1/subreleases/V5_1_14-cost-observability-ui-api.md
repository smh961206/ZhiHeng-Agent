...
Expose safe job/model cost summaries with unknown-price state.
...
Before V5.1.14, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Cost observability UI/API tests
...
- **V5.1.14-AC01:** Expose safe job/model cost summaries with unknown-price state. while quality remains the higher-priority gate.
