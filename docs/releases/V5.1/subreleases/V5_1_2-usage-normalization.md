...
Normalize provider token/cache/reasoning usage semantics.
...
Before V5.1.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Usage adapter
- provider/estimated/unknown source
...
- **V5.1.2-AC01:** Normalize provider token/cache/reasoning usage semantics. while quality remains the higher-priority gate.
