...
Aggregate call costs/retries/review by job/purpose/profile.
...
Before V5.1.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.1.4-AC01:** Aggregate call costs/retries/review by job/purpose/profile. while quality remains the higher-priority gate.
