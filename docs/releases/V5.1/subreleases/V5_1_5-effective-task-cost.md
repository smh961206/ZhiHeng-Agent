...
Include retry/tool/review completion effects for model comparison.
...
Before V5.1.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Effective-cost formula/version
...
- **V5.1.5-AC01:** Include retry/tool/review completion effects for model comparison. while quality remains the higher-priority gate.
