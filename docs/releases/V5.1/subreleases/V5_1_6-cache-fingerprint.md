...
Hash stable prefix dimensions without storing prompt content.
...
Before V5.1.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.1.6-AC01:** Hash stable prefix dimensions without storing prompt content. while quality remains the higher-priority gate.
