...
Measure observed sample count/hit ratio by fingerprint/profile.
...
Before V5.1.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.1.7-AC01:** Measure observed sample count/hit ratio by fingerprint/profile. while quality remains the higher-priority gate.
