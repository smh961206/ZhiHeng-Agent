...
Require enough observations and text-only eligibility before cache-based advantage.
...
Before V5.1.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.1.8-AC01:** Require enough observations and text-only eligibility before cache-based advantage. while quality remains the higher-priority gate.
