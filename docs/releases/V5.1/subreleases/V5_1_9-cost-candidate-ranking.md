...
Rank only models that already pass capability/quality/health.
...
Before V5.1.9, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.1.9-AC01:** Rank only models that already pass capability/quality/health. while quality remains the higher-priority gate.
