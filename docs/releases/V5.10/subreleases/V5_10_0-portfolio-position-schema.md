...
Introduce portfolios, positions and Cash explicitly.
...
Before V5.10.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Portfolio/Position Schema tests
...
- **V5.10.0-AC01:** Introduce portfolios, positions and Cash explicitly. with advisory-only behavior and no automatic holdings mutation.
