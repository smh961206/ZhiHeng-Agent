...
Compute sector/market/currency/issuer exposures.
...
Before V5.10.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.10.1-AC01:** Compute sector/market/currency/issuer exposures. with advisory-only behavior and no automatic holdings mutation.
