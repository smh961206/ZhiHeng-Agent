...
Compare alternative/cash allocations under same cutoff/mandate.
...
Before V5.10.11, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Counterfactual Allocation tests
...
- **V5.10.11-AC01:** Compare alternative/cash allocations under same cutoff/mandate. with advisory-only behavior and no automatic holdings mutation.
