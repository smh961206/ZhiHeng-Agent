# V5.10.12 — Portfolio Thesis UI/API
...
Expose portfolio theses/shared assumptions/hidden exposure.
...
Before V5.10.12, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.10.12-AC01:** Expose portfolio theses/shared assumptions/hidden exposure. with advisory-only behavior and no automatic holdings mutation.
