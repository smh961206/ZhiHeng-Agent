...
Validate reconciliation, constraints, liquidity and thesis concentration.
...
Before V5.10.13, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.10.13-AC01:** Validate reconciliation, constraints, liquidity and thesis concentration. with advisory-only behavior and no automatic holdings mutation.
