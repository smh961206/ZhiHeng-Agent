...
Compute ADV/free float/spread/impact proxies and executable limits.
...
Before V5.10.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.10.3-AC01:** Compute ADV/free float/spread/impact proxies and executable limits. with advisory-only behavior and no automatic holdings mutation.
