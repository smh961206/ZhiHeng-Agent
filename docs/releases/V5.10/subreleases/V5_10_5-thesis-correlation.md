...
Find shared Claim/Assumption dependencies across holdings.
...
Before V5.10.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.10.5-AC01:** Find shared Claim/Assumption dependencies across holdings. with advisory-only behavior and no automatic holdings mutation.
