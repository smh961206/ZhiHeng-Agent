...
Represent interest/credit/inflation/property/FX/commodity/liquidity state.
...
Before V5.10.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.10.7-AC01:** Represent interest/credit/inflation/property/FX/commodity/liquidity state. with advisory-only behavior and no automatic holdings mutation.
