# V5.10.8 — Hidden Exposure Engine
...
Map business/claim/macro links to indirect portfolio exposure.
...
Before V5.10.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.10.8-AC01:** Map business/claim/macro links to indirect portfolio exposure. with advisory-only behavior and no automatic holdings mutation.
