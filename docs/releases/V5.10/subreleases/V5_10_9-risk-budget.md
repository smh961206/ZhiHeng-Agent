...
Create hard/soft concentration/downside/liquidity/thesis constraints.
...
Before V5.10.9, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.10.9-AC01:** Create hard/soft concentration/downside/liquidity/thesis constraints. with advisory-only behavior and no automatic holdings mutation.
