...
Index research/failure/conflict/decision history with provenance.
...
Before V5.11.11, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.11.11-AC01:** Index research/failure/conflict/decision history with provenance. with no hindsight mutation of original research or decision.
