...
Generate candidates from failures/outcomes; require benchmark/human approval.
...
Before V5.11.12, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Offline Knowledge/Policy Learning tests
...
- **V5.11.12-AC01:** Generate candidates from failures/outcomes; require benchmark/human approval. with no hindsight mutation of original research or decision.
