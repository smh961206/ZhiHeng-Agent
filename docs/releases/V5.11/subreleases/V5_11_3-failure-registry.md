...
Store structured failure/root cause/severity/fix/regression.
...
Before V5.11.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.11.3-AC01:** Store structured failure/root cause/severity/fix/regression. with no hindsight mutation of original research or decision.
