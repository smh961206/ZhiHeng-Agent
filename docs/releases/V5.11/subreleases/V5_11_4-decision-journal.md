...
Persist ex-ante action/reason/assumption/invalidation/horizon.
...
Before V5.11.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.11.4-AC01:** Persist ex-ante action/reason/assumption/invalidation/horizon. with no hindsight mutation of original research or decision.
