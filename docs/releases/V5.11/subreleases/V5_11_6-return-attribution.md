...
Decompose earnings/multiple/dividend/buyback/FX/residual.
...
Before V5.11.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.11.6-AC01:** Decompose earnings/multiple/dividend/buyback/FX/residual. with no hindsight mutation of original research or decision.
