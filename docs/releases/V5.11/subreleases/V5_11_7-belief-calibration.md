...
Score resolved ex-ante probabilities.
...
Before V5.11.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Brier/log loss/calibration bins

## 7. Out of Scope

- Ambiguous forced resolution
...
- **V5.11.7-AC01:** Score resolved ex-ante probabilities. with no hindsight mutation of original research or decision.
