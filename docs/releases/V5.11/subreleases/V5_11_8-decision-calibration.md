...
Assess IRR/hit rate/drawdown by decision class/horizon with sample caveats.
...
Before V5.11.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.11.8-AC01:** Assess IRR/hit rate/drawdown by decision class/horizon with sample caveats. with no hindsight mutation of original research or decision.
