...
Add flagship tier/profiles without normal eligibility.
...
Before V5.2.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.2.0-AC01:** Add flagship tier/profiles without normal eligibility. without making flagship/Judge a default path.
