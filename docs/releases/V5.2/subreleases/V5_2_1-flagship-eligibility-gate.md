# V5.2.1 — Flagship eligibility gate
...
Define exceptional complexity/review failure conditions.
...
Before V5.2.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Flagship eligibility gate tests
...
- **V5.2.1-AC01:** Define exceptional complexity/review failure conditions. without making flagship/Judge a default path.
