# V5.2.10 — Flagship drift/usage guard
...
Alert if flagship rate/cost exceeds intended exceptional use.
...
Before V5.2.10, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Hard quota that reduces quality
...
- Flagship drift/usage guard tests
...
- **V5.2.10-AC01:** Alert if flagship rate/cost exceeds intended exceptional use. without making flagship/Judge a default path.
