# V5.2.2 — Critical review escalation
...
Escalate reviewer only after repeated validated semantic/format failure.
...
Before V5.2.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Critical review escalation tests
...
- **V5.2.2-AC01:** Escalate reviewer only after repeated validated semantic/format failure. without making flagship/Judge a default path.
