...
Detect material L1/L2 disagreement on defined claims/valuation.
...
Before V5.2.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.2.3-AC01:** Detect material L1/L2 disagreement on defined claims/valuation. without making flagship/Judge a default path.
