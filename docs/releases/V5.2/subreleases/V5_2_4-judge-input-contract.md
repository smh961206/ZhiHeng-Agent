...
Build normalized evidence/tool/conclusion packet.
...
Before V5.2.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.2.4-AC01:** Build normalized evidence/tool/conclusion packet. without making flagship/Judge a default path.
