...
Restrict outcome to accept_l1/accept_l2/insufficient_to_decide.
...
Before V5.2.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.2.5-AC01:** Restrict outcome to accept_l1/accept_l2/insufficient_to_decide. without making flagship/Judge a default path.
