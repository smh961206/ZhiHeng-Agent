...
Reject unsupported judge choice and preserve unresolved state.
...
Before V5.2.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.2.6-AC01:** Reject unsupported judge choice and preserve unresolved state. without making flagship/Judge a default path.
