...
Track cost, latency, conflict type and value.
...
Before V5.2.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.2.7-AC01:** Track cost, latency, conflict type and value. without making flagship/Judge a default path.
