...
Assign stable IDs/metadata to 20–50 highest-impact existing rules.
...
Before V5.3.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Rule type/scope/severity/enforcement/rationale/tests
...
- **V5.3.1-AC01:** Assign stable IDs/metadata to 20–50 highest-impact existing rules. while preserving pinned legacy Knowledge behavior.
