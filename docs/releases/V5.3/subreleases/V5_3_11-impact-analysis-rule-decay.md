# V5.3.11 — Impact analysis / rule decay
...
Map affected modes/archetypes/claims/benchmarks and temporal validity.
...
Before V5.3.11, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Impact report
- lastValidatedAt/needs_review/effective dates

## 7. Out of Scope

- Automatic old-state rewrite
...
- Impact analysis / rule decay tests
...
- **V5.3.11-AC01:** Map affected modes/archetypes/claims/benchmarks and temporal validity. while preserving pinned legacy Knowledge behavior.
