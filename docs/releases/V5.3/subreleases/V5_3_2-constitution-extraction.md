# V5.3.2 — Constitution extraction
...
Extract stable permanent research principles into a small ordered layer.
...
Before V5.3.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.3.2-AC01:** Extract stable permanent research principles into a small ordered layer. while preserving pinned legacy Knowledge behavior.
