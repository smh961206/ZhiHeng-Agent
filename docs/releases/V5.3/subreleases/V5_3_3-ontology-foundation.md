...
Define canonical Period/Currency/Metric/Security/ShareBasis/Scope/Valuation concepts.
...
Before V5.3.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.3.3-AC01:** Define canonical Period/Currency/Metric/Security/ShareBasis/Scope/Valuation concepts. while preserving pinned legacy Knowledge behavior.
