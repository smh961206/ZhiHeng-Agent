...
Resolve Knowledge Pack by mode/archetype/claim/method with legacy comparison.
...
Before V5.3.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.3.4-AC01:** Resolve Knowledge Pack by mode/archetype/claim/method with legacy comparison. while preserving pinned legacy Knowledge behavior.
