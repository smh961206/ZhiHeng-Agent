...
Compile deduplicated ordered minimal Knowledge context and fingerprint.
...
Before V5.3.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Constitution→Ontology→Methodology→Playbook→Contract pack
- Fingerprint
...
- **V5.3.5-AC01:** Compile deduplicated ordered minimal Knowledge context and fingerprint. while preserving pinned legacy Knowledge behavior.
