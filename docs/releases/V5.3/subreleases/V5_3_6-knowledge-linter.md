...
Detect duplicate IDs, undefined refs, conflicts, cycles, orphan rules and missing scope/tests.
...
Before V5.3.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.3.6-AC01:** Detect duplicate IDs, undefined refs, conflicts, cycles, orphan rules and missing scope/tests. while preserving pinned legacy Knowledge behavior.
