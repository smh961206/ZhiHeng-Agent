...
Start semantic K version and pin per research job.
...
Before V5.3.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.3.8-AC01:** Start semantic K version and pin per research job. while preserving pinned legacy Knowledge behavior.
