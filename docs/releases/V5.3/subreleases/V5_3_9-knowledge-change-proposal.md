...
Formalize root-cause KCP and Knowledge Debt.
...
Before V5.3.9, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Knowledge Change Proposal tests
...
- **V5.3.9-AC01:** Formalize root-cause KCP and Knowledge Debt. while preserving pinned legacy Knowledge behavior.
