...
Canonicalize provider/source/time/hash metadata for new source writes.
...
Before V5.4.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.4.0-AC01:** Canonicalize provider/source/time/hash metadata for new source writes. without degrading exact financial evidence retrieval.
