...
Add ranked lexical retrieval retaining exact/alias/page filters.
...
Before V5.4.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.4.2-AC01:** Add ranked lexical retrieval retaining exact/alias/page filters. without degrading exact financial evidence retrieval.
