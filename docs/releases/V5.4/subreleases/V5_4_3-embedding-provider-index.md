...
Add versioned embeddings for eligible qualitative evidence.
...
Before V5.4.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Embedding provider/index tests
...
- **V5.4.3-AC01:** Add versioned embeddings for eligible qualitative evidence. without degrading exact financial evidence retrieval.
