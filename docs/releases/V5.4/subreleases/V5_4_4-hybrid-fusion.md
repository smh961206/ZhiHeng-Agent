...
Merge exact/BM25/semantic/page/table channels deterministically.
...
Before V5.4.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.4.4-AC01:** Merge exact/BM25/semantic/page/table channels deterministically. without degrading exact financial evidence retrieval.
