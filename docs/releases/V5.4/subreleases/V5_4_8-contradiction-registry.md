...
Store unresolved/resolved data/period/scope/definition/revision/source conflicts.
...
Before V5.4.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.4.8-AC01:** Store unresolved/resolved data/period/scope/definition/revision/source conflicts. without degrading exact financial evidence retrieval.
