...
Map current resolver semantics/ambiguities before stable schema.
...
Before V5.5.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Security identity inventory tests
...
- **V5.5.0-AC01:** Map current resolver semantics/ambiguities before stable schema. with additive migration and no historical overwrite.
