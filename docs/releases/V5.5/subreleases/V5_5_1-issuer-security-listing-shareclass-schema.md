...
Add stable entity objects and time-bounded listing identity.
...
Before V5.5.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Issuer/Security/Listing/ShareClass schema tests
...
- **V5.5.1-AC01:** Add stable entity objects and time-bounded listing identity. with additive migration and no historical overwrite.
