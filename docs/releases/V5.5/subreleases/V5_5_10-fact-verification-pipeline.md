...
Promote observed/extracted data to verified only with required lineage/checks.
...
Before V5.5.10, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Fact Verification Pipeline tests
...
- **V5.5.10-AC01:** Promote observed/extracted data to verified only with required lineage/checks. with additive migration and no historical overwrite.
