...
Resolve by authority/period/scope/revision policy or remain conflicted.
...
Before V5.5.12, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.5.12-AC01:** Resolve by authority/period/scope/revision policy or remain conflicted. with additive migration and no historical overwrite.
