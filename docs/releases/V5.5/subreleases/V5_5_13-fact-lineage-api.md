...
Expose Fact→Evidence→Source/page/revision to research/UI.
...
Before V5.5.13, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.5.13-AC01:** Expose Fact→Evidence→Source/page/revision to research/UI. with additive migration and no historical overwrite.
