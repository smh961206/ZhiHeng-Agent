...
Resolve ticker/name/external IDs to canonical identities with ambiguity.
...
Before V5.5.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Identifier Resolver Bridge tests
...
- **V5.5.2-AC01:** Resolve ticker/name/external IDs to canonical identities with ambiguity. with additive migration and no historical overwrite.
