...
Represent splits/dividends/rights/placements/buybacks/cancellations with dates/lineage.
...
Before V5.5.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- CorporateAction records
- Share impact references

## 7. Out of Scope

- Tax/convertibles full engine
...
- **V5.5.3-AC01:** Represent splits/dividends/rights/placements/buybacks/cancellations with dates/lineage. with additive migration and no historical overwrite.
