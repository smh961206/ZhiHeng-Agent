...
Add canonical Fact sidecar around financial observations.
...
Before V5.5.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.5.4-AC01:** Add canonical Fact sidecar around financial observations. with additive migration and no historical overwrite.
