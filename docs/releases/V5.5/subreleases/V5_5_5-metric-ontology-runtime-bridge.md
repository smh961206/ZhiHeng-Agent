# V5.5.5 — Metric Ontology runtime bridge
...
Map first 30–50 key metrics from XBRL/provider/PDF labels.
...
Before V5.5.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Metric Ontology runtime bridge tests
...
- **V5.5.5-AC01:** Map first 30–50 key metrics from XBRL/provider/PDF labels. with additive migration and no historical overwrite.
