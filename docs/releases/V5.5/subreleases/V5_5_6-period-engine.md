...
Enforce FY/TTM/YTD/Q/H/Instant semantics.
...
Before V5.5.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.5.6-AC01:** Enforce FY/TTM/YTD/Q/H/Instant semantics. with additive migration and no historical overwrite.
