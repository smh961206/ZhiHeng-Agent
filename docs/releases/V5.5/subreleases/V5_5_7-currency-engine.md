...
Separate reporting/market/valuation currencies and FX lineage.
...
Before V5.5.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.5.7-AC01:** Separate reporting/market/valuation currencies and FX lineage. with additive migration and no historical overwrite.
