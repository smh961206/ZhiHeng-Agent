...
Enforce consolidated/parent/attributable/common/total equity scopes.
...
Before V5.5.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.5.8-AC01:** Enforce consolidated/parent/attributable/common/total equity scopes. with additive migration and no historical overwrite.
