...
Distinguish diluted/weighted-average/period-end/ADR-equivalent shares.
...
Before V5.5.9, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.5.9-AC01:** Distinguish diluted/weighted-average/period-end/ADR-equivalent shares. with additive migration and no historical overwrite.
