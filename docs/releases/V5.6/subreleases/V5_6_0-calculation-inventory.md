...
Map existing formula/tool semantics and golden outputs.
...
Before V5.6.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.6.0-AC01:** Map existing formula/tool semantics and golden outputs. with no silent formula semantics change.
