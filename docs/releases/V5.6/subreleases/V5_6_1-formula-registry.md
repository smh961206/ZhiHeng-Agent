...
Give current formulas stable IDs/versions.
...
Before V5.6.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.6.1-AC01:** Give current formulas stable IDs/versions. with no silent formula semantics change.
