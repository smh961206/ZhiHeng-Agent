...
Show claim status/support/counter/gaps without replacing report.
...
Before V5.6.11, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.6.11-AC01:** Show claim status/support/counter/gaps without replacing report. with no silent formula semantics change.
