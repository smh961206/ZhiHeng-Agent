# V5.6.2 — Calculation Record wrapper
...
Add calculationId/input lineage/unit/currency around current tool outputs.
...
Before V5.6.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Calculation Record wrapper tests
...
- **V5.6.2-AC01:** Add calculationId/input lineage/unit/currency around current tool outputs. with no silent formula semantics change.
