...
Make non-fact forecast/valuation inputs explicit.
...
Before V5.6.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Assumption objects
- Evidence/sensitivity/invalidation
...
- **V5.6.3-AC01:** Make non-fact forecast/valuation inputs explicit. with no silent formula semantics change.
