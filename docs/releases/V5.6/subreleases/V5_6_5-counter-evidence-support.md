# V5.6.5 — Counter-evidence support
...
Make support vs counter evidence first-class.
...
Before V5.6.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Separate collections/review checks
...
- Counter-evidence support tests
...
- **V5.6.5-AC01:** Make support vs counter evidence first-class. with no silent formula semantics change.
