...
Add acyclic dependsOn/horizon relationships.
...
Before V5.6.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.6.6-AC01:** Add acyclic dependsOn/horizon relationships. with no silent formula semantics change.
