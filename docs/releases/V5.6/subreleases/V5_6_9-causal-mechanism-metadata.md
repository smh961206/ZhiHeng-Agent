...
Record cause/mechanism/effect/alternative explanations with evidence strength.
...
Before V5.6.9, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Causal Mechanism metadata tests
...
- **V5.6.9-AC01:** Record cause/mechanism/effect/alternative explanations with evidence strength. with no silent formula semantics change.
