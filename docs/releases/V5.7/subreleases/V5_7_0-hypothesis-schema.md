...
Represent competing explanations for ambiguous phenomena.
...
Before V5.7.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.7.0-AC01:** Represent competing explanations for ambiguous phenomena. while Fact/Forecast/Assumption epistemic states remain distinct.
