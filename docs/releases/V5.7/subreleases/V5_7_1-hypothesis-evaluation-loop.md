...
Retrieve discriminating and disconfirming evidence for competing hypotheses.
...
Before V5.7.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Hypothesis Evaluation Loop tests
...
- **V5.7.1-AC01:** Retrieve discriminating and disconfirming evidence for competing hypotheses. while Fact/Forecast/Assumption epistemic states remain distinct.
