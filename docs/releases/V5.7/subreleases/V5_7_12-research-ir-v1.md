...
Represent target/asOf/mode/claims/evidence requirements/methods/constraints.
...
Before V5.7.12, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.7.12-AC01:** Represent target/asOf/mode/claims/evidence requirements/methods/constraints. while Fact/Forecast/Assumption epistemic states remain distinct.
