...
Expose critical-claim/gap/uncertainty/valuation readiness only.
...
Before V5.7.13, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Decision Readiness Inputs tests
...
- **V5.7.13-AC01:** Expose critical-claim/gap/uncertainty/valuation readiness only. while Fact/Forecast/Assumption epistemic states remain distinct.
