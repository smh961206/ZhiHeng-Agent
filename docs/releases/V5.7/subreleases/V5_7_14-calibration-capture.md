...
Persist ex-ante probabilistic predictions with resolution criteria.
...
Before V5.7.14, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.7.14-AC01:** Persist ex-ante probabilistic predictions with resolution criteria. while Fact/Forecast/Assumption epistemic states remain distinct.
