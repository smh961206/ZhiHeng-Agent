...
Separate claim status from prior/current probability.
...
Before V5.7.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.7.2-AC01:** Separate claim status from prior/current probability. while Fact/Forecast/Assumption epistemic states remain distinct.
