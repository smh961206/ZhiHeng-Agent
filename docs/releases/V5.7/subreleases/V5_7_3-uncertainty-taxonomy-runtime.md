# V5.7.3 — Uncertainty Taxonomy Runtime
...
Route data/model/structural/future/irreducible uncertainty appropriately.
...
Before V5.7.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Uncertainty Taxonomy Runtime tests
...
- **V5.7.3-AC01:** Route data/model/structural/future/irreducible uncertainty appropriately. while Fact/Forecast/Assumption epistemic states remain distinct.
