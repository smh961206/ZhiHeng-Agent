...
Define Forecast nodes driven by Facts/Assumptions/Scenario.
...
Before V5.7.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.7.4-AC01:** Define Forecast nodes driven by Facts/Assumptions/Scenario. while Fact/Forecast/Assumption epistemic states remain distinct.
