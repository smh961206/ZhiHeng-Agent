...
Implement simple growth and optional volume×price/mix chain.
...
Before V5.7.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Universal forced decomposition
...
- **V5.7.5-AC01:** Implement simple growth and optional volume×price/mix chain. while Fact/Forecast/Assumption epistemic states remain distinct.
