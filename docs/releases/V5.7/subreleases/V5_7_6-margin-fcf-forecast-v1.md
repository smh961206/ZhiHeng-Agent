...
Implement reproducible margin and FCF projection chains.
...
Before V5.7.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.7.6-AC01:** Implement reproducible margin and FCF projection chains. while Fact/Forecast/Assumption epistemic states remain distinct.
