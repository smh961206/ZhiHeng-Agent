...
Create coherent Base/Bull/Bear assumption sets.
...
Before V5.7.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.7.7-AC01:** Create coherent Base/Bull/Bear assumption sets. while Fact/Forecast/Assumption epistemic states remain distinct.
