...
Add canonical event IDs/type/entity/source/time semantics.
...
Before V5.8.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.8.0-AC01:** Add canonical event IDs/type/entity/source/time semantics. without mutating validated state before revalidation.
