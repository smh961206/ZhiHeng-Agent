...
Classify earnings/guidance/dividend/buyback/capital raise/management/contract/regulation.
...
Before V5.8.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.8.1-AC01:** Classify earnings/guidance/dividend/buyback/capital raise/management/contract/regulation. without mutating validated state before revalidation.
