...
Run idempotent governed refresh after prior semantics are stable.
...
Before V5.8.10, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.8.10-AC01:** Run idempotent governed refresh after prior semantics are stable. without mutating validated state before revalidation.
