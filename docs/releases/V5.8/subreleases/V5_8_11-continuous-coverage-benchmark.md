# V5.8.11 — Continuous Coverage Benchmark
...
Validate affected-claim recall and avoided unnecessary reruns.
...
Before V5.8.11, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Continuous Coverage Benchmark tests
...
- **V5.8.11-AC01:** Validate affected-claim recall and avoided unnecessary reruns. without mutating validated state before revalidation.
