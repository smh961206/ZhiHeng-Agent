...
Classify ignore/archive/monitor/partial/full/critical.
...
Before V5.8.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Materiality inputs/rules

## 7. Out of Scope

- Portfolio weights full integration
...
- **V5.8.3-AC01:** Classify ignore/archive/monitor/partial/full/critical. without mutating validated state before revalidation.
