...
Represent Fact/Claim/Belief/Assumption/Valuation/Risk/Gaps changes.
...
Before V5.8.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.8.4-AC01:** Represent Fact/Claim/Belief/Assumption/Valuation/Risk/Gaps changes. without mutating validated state before revalidation.
