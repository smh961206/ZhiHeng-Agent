# V5.8.5 — Selective Revalidation Planner
...
Use DAG/materiality to recheck affected subgraph.
...
Before V5.8.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Selective Revalidation Planner tests
...
- **V5.8.5-AC01:** Use DAG/materiality to recheck affected subgraph. without mutating validated state before revalidation.
