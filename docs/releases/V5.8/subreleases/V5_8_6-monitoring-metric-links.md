# V5.8.6 — Monitoring Metric Links
...
Bind Claims to monitored metrics/freshness/thresholds.
...
Before V5.8.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.8.6-AC01:** Bind Claims to monitored metrics/freshness/thresholds. without mutating validated state before revalidation.
