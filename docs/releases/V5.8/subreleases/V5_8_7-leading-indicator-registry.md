...
Represent pre-report indicators with quality/source semantics.
...
Before V5.8.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Leading Indicator Registry tests
...
- **V5.8.7-AC01:** Represent pre-report indicators with quality/source semantics. without mutating validated state before revalidation.
