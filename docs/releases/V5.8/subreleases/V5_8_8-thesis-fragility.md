...
Compute inspectable fragility components for monitoring priority.
...
Before V5.8.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.8.8-AC01:** Compute inspectable fragility components for monitoring priority. without mutating validated state before revalidation.
