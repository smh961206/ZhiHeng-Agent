...
Prioritize coverage by fragility/new info/sensitivity/uncertainty/optional position weight.
...
Before V5.8.9, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.8.9-AC01:** Prioritize coverage by fragility/new info/sensitivity/uncertainty/optional position weight. without mutating validated state before revalidation.
