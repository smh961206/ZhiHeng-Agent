# V5.9.0 — Investment Mandate Schema
...
Store investor objective/horizon/return/risk/liquidity/concentration constraints.
...
Before V5.9.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Investment Mandate Schema tests
...
- **V5.9.0-AC01:** Store investor objective/horizon/return/risk/liquidity/concentration constraints. without allowing prose to override hard mandate constraints.
