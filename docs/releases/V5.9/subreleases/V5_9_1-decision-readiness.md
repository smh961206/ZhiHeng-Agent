...
Compute ready/conditional/not_ready and blockers.
...
Before V5.9.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.9.1-AC01:** Compute ready/conditional/not_ready and blockers. without allowing prose to override hard mandate constraints.
