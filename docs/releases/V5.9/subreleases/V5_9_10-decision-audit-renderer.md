...
Explain decision via structured mandate/state/opportunity/calculation/gaps.
...
Before V5.9.10, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.9.10-AC01:** Explain decision via structured mandate/state/opportunity/calculation/gaps. without allowing prose to override hard mandate constraints.
