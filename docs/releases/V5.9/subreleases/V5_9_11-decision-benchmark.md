...
Test no-action correctness, constraints, robustness and cash choice.
...
Before V5.9.11, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.9.11-AC01:** Test no-action correctness, constraints, robustness and cash choice. without allowing prose to override hard mandate constraints.
