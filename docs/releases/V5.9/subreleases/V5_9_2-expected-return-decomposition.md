...
Decompose earnings/dividend/buyback/multiple/FX.
...
Before V5.9.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Expected Return Decomposition tests
...
- **V5.9.2-AC01:** Decompose earnings/dividend/buyback/multiple/FX. without allowing prose to override hard mandate constraints.
