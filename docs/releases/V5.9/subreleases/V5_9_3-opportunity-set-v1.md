...
Compare multiple candidates plus Cash under same mandate/horizon.
...
Before V5.9.3, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.9.3-AC01:** Compare multiple candidates plus Cash under same mandate/horizon. without allowing prose to override hard mandate constraints.
