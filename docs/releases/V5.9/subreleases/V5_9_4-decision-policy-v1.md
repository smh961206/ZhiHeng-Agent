...
Govern Reject/Watch/Starter/Normal/HighConviction/Reduce/Exit.
...
Before V5.9.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.9.4-AC01:** Govern Reject/Watch/Starter/Normal/HighConviction/Reduce/Exit. without allowing prose to override hard mandate constraints.
