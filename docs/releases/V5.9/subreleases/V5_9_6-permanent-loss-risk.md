...
Assess leverage/liquidity/refinancing/survival separately from volatility.
...
Before V5.9.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.9.6-AC01:** Assess leverage/liquidity/refinancing/survival separately from volatility. without allowing prose to override hard mandate constraints.
