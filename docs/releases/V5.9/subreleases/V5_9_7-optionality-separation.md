...
Separate core/verified/speculative optionality.
...
Before V5.9.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V5.9.7-AC01:** Separate core/verified/speculative optionality. without allowing prose to override hard mandate constraints.
