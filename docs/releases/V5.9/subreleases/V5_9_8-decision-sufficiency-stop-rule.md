# V5.9.8 — Decision Sufficiency Stop Rule
...
Stop when critical decision information is sufficient.
...
Before V5.9.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Decision Sufficiency Stop Rule tests
...
- **V5.9.8-AC01:** Stop when critical decision information is sufficient. without allowing prose to override hard mandate constraints.
