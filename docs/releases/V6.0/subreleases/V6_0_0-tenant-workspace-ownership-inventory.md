...
Map every current object as global/user/workspace before migration.
...
Before V6.0.0, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Tenant/Workspace Ownership Inventory tests
...
- **V6.0.0-AC01:** Map every current object as global/user/workspace before migration. without weakening investment-research invariants.
