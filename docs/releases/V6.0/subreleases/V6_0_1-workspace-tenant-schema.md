...
Add workspace/tenant objects and default single-user workspace.
...
Before V6.0.1, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V6.0.1-AC01:** Add workspace/tenant objects and default single-user workspace. without weakening investment-research invariants.
