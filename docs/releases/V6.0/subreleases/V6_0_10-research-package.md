...
Export manifest/facts/claims/beliefs/assumptions/calcs/valuation/state/provenance/report.
...
Before V6.0.10, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V6.0.10-AC01:** Export manifest/facts/claims/beliefs/assumptions/calcs/valuation/state/provenance/report. without weakening investment-research invariants.
