...
Define versioned interoperable Research Package protocol.
...
Before V6.0.11, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V6.0.11-AC01:** Define versioned interoperable Research Package protocol. without weakening investment-research invariants.
