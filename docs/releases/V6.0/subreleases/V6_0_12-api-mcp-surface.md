...
Expose permissioned structured read/search/export/write operations.
...
Before V6.0.12, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V6.0.12-AC01:** Expose permissioned structured read/search/export/write operations. without weakening investment-research invariants.
