...
Scope schedules/budgets/events to workspaces.
...
Before V6.0.14, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Tenant-safe Continuous Research tests
...
- **V6.0.14-AC01:** Scope schedules/budgets/events to workspaces. without weakening investment-research invariants.
