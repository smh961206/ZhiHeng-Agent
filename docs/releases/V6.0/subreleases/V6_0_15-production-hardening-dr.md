...
Add backup/restore/SLO/retention/incidents/provider outage drills.
...
Before V6.0.15, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V6.0.15-AC01:** Add backup/restore/SLO/retention/incidents/provider outage drills. without weakening investment-research invariants.
