...
Add Owner/Researcher/Reviewer/Viewer server-side permission matrix.
...
Before V6.0.2, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V6.0.2-AC01:** Add Owner/Researcher/Reviewer/Viewer server-side permission matrix. without weakening investment-research invariants.
