...
Add PUBLIC/PRIVATE/CONFIDENTIAL/RESTRICTED policies.
...
Before V6.0.4, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V6.0.4-AC01:** Add PUBLIC/PRIVATE/CONFIDENTIAL/RESTRICTED policies. without weakening investment-research invariants.
