...
Enforce allowed models/providers by workspace/classification.
...
Before V6.0.5, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V6.0.5-AC01:** Enforce allowed models/providers by workspace/classification. without weakening investment-research invariants.
