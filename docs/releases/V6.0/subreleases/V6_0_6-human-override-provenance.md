...
Add actor/old/new/reason/time/sticky override semantics.
...
Before V6.0.6, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Human Override Provenance tests
...
- **V6.0.6-AC01:** Add actor/old/new/reason/time/sticky override semantics. without weakening investment-research invariants.
