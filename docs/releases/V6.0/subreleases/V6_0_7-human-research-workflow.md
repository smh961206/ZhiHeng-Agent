...
Approve/reject/pin/override/add assumption/request recheck/comment.
...
Before V6.0.7, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- **V6.0.7-AC01:** Approve/reject/pin/override/add assumption/request recheck/comment. without weakening investment-research invariants.
