...
Add structured navigation across thesis/claims/beliefs/facts/etc.
...
Before V6.0.8, the owning release capability is either absent, partial, or still on the previous accepted implementation.
...
- Research Workbench Shell tests
...
- **V6.0.8-AC01:** Add structured navigation across thesis/claims/beliefs/facts/etc. without weakening investment-research invariants.
