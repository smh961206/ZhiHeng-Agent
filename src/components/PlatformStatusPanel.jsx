...
export default function PlatformStatusPanel({trigger,open,onOpenChange,titleId,statusTitle,statusDescription,checking,onRefresh}){
 return <Popover open={open} onOpenChange={onOpenChange}>
  ...
  <PopoverContent align="end" className="platform-status-panel" aria-labelledby={titleId}>
   ...
   <div className="platform-connection" role="status"><strong>{statusTitle}</strong><p>{statusDescription}</p></div>
