...
const questions=[
 ['图片和扫描件需要自己选模型吗？','无需在研究表单里选择模型。先确认研究问题、路径与资料，平台按已启用的配置执行。模型调整先做同题对照，检查事实、计算和引用，再比较速度与成本；完成验收后才可启用。资料不足仍保留缺口，不以更换模型代替取证。'],
