...
import {modes,researchStages,outputContract} from '../domain/research-framework.ts';
...
import {researchDataCopy} from '../domain/research-data-copy.ts';
