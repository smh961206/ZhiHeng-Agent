...
export default function ResearchMethod(){
 return <section className="research-method" aria-labelledby="research-method-title">
  ...
  <section className="fw-section" aria-labelledby="method-sequence-title">
   ...
   <div className="fw-principle-panel"><span className="fw-principle-label">当前研究方法 · V{frameworkVersion}</span><p className="fw-principle-question">先判断公司与价值，再讨论执行。</p>
  ...
  <section id="method-loading" tabIndex={-1} className="fw-section" aria-labelledby="method-loading-title">
   <div className="fw-section-heading"><h3 id="method-loading-title">V{frameworkVersion} · 规则按需使用，研究依据可回查</h3><p>本次更新优化规则的组织、加载与追溯方式。投资公式、评分权重和判断条件保持原意。</p></div>
   <KnowledgeHighlights/>
