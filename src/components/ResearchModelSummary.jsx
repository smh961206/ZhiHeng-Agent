...
export default function ResearchModelSummary({job}){
 ...
 return <section className="rd-model-assignment" aria-label="处理环节记录">
  <header className="rd-document-summary"><span className="rd-document-icon"><Workflow size={18}/></span><span className="rd-document-heading"><strong>处理环节记录</strong><span>创建研究时保存的服务分工；有记录不表示实际执行</span></span><span className="rd-document-label">配置记录</span></header>
