...
const screenExamples=[['比亚迪快速筛选','快速筛选比亚迪是否值得进一步研究，重点检查现金流、存货与资本开支。'],['苹果财务快筛','快速筛选苹果是否值得进一步研究，重点检查盈利质量与估值适用性。']];
 ...
 return <section className="research-workbench">
  ...
  <div className="workspace-grid">
   <Card className="workbench-composer gap-0 py-0">
    <CardHeader className="composer-intro"><div><span className="composer-title-icon"><Sparkles size={19}/></span><div><h2>{quick?'开启一项快速筛选':'开启一项新研究'}</h2><p>{quick?'结合五年趋势与近期变化，找出值得查证的问题。':'明确问题，剩下的交给研究流程。'}</p></div></div><span className="composer-private"><ShieldCheck size={13}/>证据可追溯</span></CardHeader>
